...
@section('content')
                ...
                <div class="col-lg-12 p-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            ...
                            {{-- modal tambah data --}}
                            <form action="{{ url('/dashboard/gejala/store') }}" method="post" id="formData">
                                @csrf
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="kd_gejala"
                                                        class="form-control @error('kd_gejala')
                                                        is-invalid
                                                    @enderror">
                                                    @error('kd_gejala')
                                                ...
                                                <div class="mb-3">
                                                    <label for="nama_gejala"
                                                        class="form-label @error('nama_gejala')
                                                        is-invalid
                                                    @enderror">Nama
                                                        Gejala</label>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-orderable="true">Nama Gejala</th>
                                        ...
                                        <td>
                                            <div class="btn-group gap-1">
                                                <button class="btn btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modalEdit{{ $item->kd_gejala }}">
                                                ...
                                                <form id="deleteForm"
                                                    action="{{ url('/dashboard/gejala/' . $item->kd_gejala) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    {{-- modal edit data --}}
    @foreach ($gejala as $item)
        <form id="editForm" action="{{ url('/dashboard/gejala/edit/' . $item->kd_gejala) }}" method="post">
            @csrf
            @method('put')
            <!-- Modal -->
            <div class="modal fade" id="modalEdit{{ $item->kd_gejala }}" tabindex="-1" aria-labelledby="modalEditLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <!-- form edit -->
                            <div class="mb-3">
                                <label for="kd_gejala" class="form-label">Kode Penyakit</label>
                                <input type="text" id="kd_gejala" name="kd_gejala"
                                    class="form-control @error('kd_gejala')
                                    is-invalid
                                @enderror"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="nama_gejala" name="nama_gejala"
                                    class="form-control @error('nama_gejala')
                                    is-invalid
                                @enderror"
