...
@section('content')
                ...
                <div class="col-lg-12 p-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-end">
                            ...
                            {{-- modal tambah data --}}
                            <form action="{{ url('/dashboard/penyakit/store') }}" method="post">
                                @csrf
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="kd_penyakit" class="form-control">
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <label for="penyembuhan" class="form-label">Saran Penyembuhan</label>
                                                    <input type="text" name="penyembuhan" class="form-control">
                                                </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th data-orderable="true">Nama penyakit</th>
                                    <th data-orderable="true">Saran Penyembuhan</th>
                            ...
                            <tbody>
                                @foreach ($penyakit as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->penyembuhan }}</td>
                                        <td>
                                            <div class="btn-group gap-1">
                                                <button class="btn btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modalEdit{{ $item->kd_penyakit }}">
                                                ...
                                                <form id="deleteForm" action="{{ url('/dashboard/penyakit/'. $item->kd_penyakit) }}" method="post">
                                                    @csrf
                                                    @method('delete')
    ...
    {{-- modal edit data --}}
    @foreach ($penyakit as $item)
        <form id="editForm" action="{{ url('/dashboard/penyakit/edit/' . $item->kd_penyakit) }}" method="post">
            @csrf
            @method('put')
            <!-- Modal -->
            <div class="modal fade" id="modalEdit{{ $item->kd_penyakit }}" tabindex="-1"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="kd_penyakit" class="form-label">Kode Penyakit</label>
                                <input type="text" id="kd_penyakit" name="kd_penyakit" class="form-control"
                            ...
                            <div class="mb-3">
                                <label for="penyembuhan" class="form-label">Saran Penyembuhan</label>
                                <input type="text" id="penyembuhan" name="penyembuhan" class="form-control"
                                    value="{{ $item->penyembuhan }}">
                            </div>
                            <!-- -->
                        </div>
                        <div class="modal-footer">
